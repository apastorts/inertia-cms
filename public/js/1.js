  ...
  function() {
    ...
    return _c("div", [
      ...
      _c("div", { staticClass: "pt-32" }, [
        _c(
          "div",
          { staticClass: "w-2/3 md:w-1/3 mx-auto bg-white shadow p-4" },
          [
            _c(
              "div",
              { staticClass: "p-4 text-lg font-bold w-full text-center" },
              [_vm._v("\n\t\t\t\tWelcome Back\n\t\t\t")]
            ),
            _vm._v(" "),
            _c(
              ...
              [
                ...
                _c(
                  ...
                  {
                    staticClass:
                      "w-full bg-orange-500 hover:bg-orange-600 text-white font-bold text-center p-4 shadow"
                  },
                  [_vm._v("Log In")]
                )
              ]
